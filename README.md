...
- This project was intially for predicting win rate percentage for champions only, but there was too much noise so I have to add a 10 more columns for champions winrate. Unfortunately i could not finished this because I simply do not have enough RAM
 ...
 - Before adding winrate, random forest was overfitting a lot and the other model just did not perform well at all, so I had to add champions winrate as well but 16 RAM was not enough for 10 millions line of data, I cant even sample a small amount since I cannot read the 10 millions line in anyway.
